                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                  ...
                  <form method="POST" action="{{route('admin.tables.update', $table->id)}}">
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                          <input value="{{$table->name}}" type="text" id="name" name="name" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('name') border-red-400 @enderror" />
                        </div>
                          @error('name')
                    ...
                    <div class="sm:col-span-6 pt-5">
                      ...
                      <div class="mt-1">
                        <select name="status" id="status" class="form-multiselect block w-full mt-1 @error('status') border-red-400 @enderror">
                    ...
                    <div class="sm:col-span-6 pt-5">
                      ...
                      <div class="mt-1">
                        <select name="location" id="location" class="form-multiselect block w-full mt-1 @error('location') border-red-400 @enderror">
